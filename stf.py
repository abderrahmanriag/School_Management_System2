...
class Staff:
    def __init__(self, frame, win, background):
        ...
        self.university_info.grid(row=0, column=2)
        self.img1 = Image.open('icons/staff200.png')
        ...
        self.univ_button=ttk.Button(self.university_info, text='Staff Management', style='style1.TButton', command=self.open_stf_win)
        self.univ_button.pack()

    def open_stf_win(self):
        StaffWindow(self.win)
